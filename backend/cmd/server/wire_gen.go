...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	modelPlazaService := service.NewModelPlazaService(accountRepository, channelService, pricingService)
	modelPlazaHandler := handler.NewModelPlazaHandler(modelPlazaService)
